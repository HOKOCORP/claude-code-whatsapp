...
💰 /topup          Request more API credits
🌐 /domain         Show your hosted project URL
🤖 /help           Show this list
...
*Admin (any chat):*
🎟️ /invite [USD]       Create invite link, optional pre-fund
👥 /users              List users with hash · name · balance
✏️ /rename HASH NAME   Rename a user
💰 /topup HASH USD     Add credit to a user's balance

*Admin (inside a group):*
