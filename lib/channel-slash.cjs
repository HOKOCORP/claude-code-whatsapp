...
*Balance limits:*
🚧 /minbalance                     Show global + per-user floor overrides
🚧 /minbalance global <amount>     Set global minimum balance
🚧 /minbalance <hash> <amount>     Per-user override (≥ HARD_FLOOR_GBP, default £5)
...
*Host:*
🖥️ /sysinfo            Host RAM, swap, disk, and per-chat cgroup usage
